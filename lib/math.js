...
function getContourPoints({ points }) {
    ...
    console.info(step, selection);
    let distances2 = new Array(selection.length - 1);
    for (i = 0; i < distances2.length; i++) {
        distances2[i] = pointPointDistance(selection[i], selection[i + 1]);
    }
    console.info(distances2);
